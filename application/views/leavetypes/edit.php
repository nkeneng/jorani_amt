...
<div class="input-append">
    <input type="text" name="acronym" id="acronym"
           value="<?php echo $leavetype['acronym']; ?>"/>
    <a id="cmdSuggestAcronym"
...
<label for="deduct_days_off">
    <input type="checkbox" name="deduct_days_off"
           id="deduct_days_off" <?php if ($leavetype['deduct_days_off'] == TRUE) {
        echo "checked";
    } ?> />
...
<label for="auto_confirm">
    <input type="checkbox" name="auto_confirm"
           id="auto_confirm" <?php if ($leavetype['auto_confirm'] == TRUE) {
        echo "checked";
    } ?> />
    <?php echo lang('auto_confirm'); ?>
</label>
<br/>
</form>
