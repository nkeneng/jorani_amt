...
<div class="row-fluid">
    <div class="span12">
        ...
        &nbsp;
        <a href="<?php echo base_url(); ?>leavetypes/create"
           class="btn btn-primary"
           data-target="#frmAddLeaveType"
           data-toggle="modal"><i
                    class="mdi mdi-plus-circle"></i>&nbsp; <?php echo lang('leavetypes_type_button_create'); ?>
        </a>
    </div>
</div>
...
<div id="frmAddLeaveType" class="modal hide fade">
    <div class="modal-header">
        <a href="#"
           onclick="$('#frmAddLeaveType').modal('hide');"
           class="close">&times;</a>
