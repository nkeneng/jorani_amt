...
<div class="row-fluid">
    <div class="span8">
        ...
        <label for="viz_startdate"><?php echo lang('hr_leaves_create_field_start'); ?></label>
        ...
        <label for="viz_enddate"><?php echo lang('hr_leaves_create_field_end'); ?></label>
        <input type="text" class="input-xxlarge"
        ...
        <a href="<?php echo base_url() . $source; ?>"
           class="btn btn-danger"><i
                    class="mdi mdi-close"></i>&nbsp; <?php echo lang('hr_leaves_create_button_cancel'); ?>
        </a>
        </form>
